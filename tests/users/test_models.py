...
def test_user_str(base_user): #base_user fixture is used 
...
def test_create_user_with_no_email(user_factory):
    ...
    assert str(err.value) == "Base User Account: Email is required"
...
def test_create_use_with_no_username(user_factory):
    ...
    assert str(err.value) == "Users must provide username"
...
def test_create_superuser_with_no_email(user_factory):
    ...
    assert str(err.value) == "Admin Account: Email is required"
...
def test_create_superuser_with_no_password(user_factory):
    ...
    assert str(err.value) == "Superusers must have valid passwords"
